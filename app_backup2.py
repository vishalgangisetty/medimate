...
def load_medical_styles():
    try:
        with open('medical_style.css') as f:
    ...
    with col2:
        st.markdown("""
            <div style='text-align: center; margin: 2rem 0 1.5rem 0;'>
                ...
                <h1 style='color: #00897B; font-weight: 700; margin: 0; font-size: 42px;'>MediMate</h1>
                <p style='color: #666; font-size: 15px; margin: 0.5rem 0 0 0;'>Your Personal Health Assistant</p>
            </div>
        """, unsafe_allow_html=True)
...
with st.sidebar:
    # User Badge
    st.markdown(f"""
        <div class='medical-card' style='text-align: center; margin-bottom: 1.5rem;'>
            <div style='font-size: 36px; margin-bottom: 0.5rem;'>�</div>
            <p class='label'>{st.session_state.user}</p>
        </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("<p class='label'>🌍 Language</p>", unsafe_allow_html=True)
    ...
    if "navigation" not in st.session_state:
        st.session_state.navigation = "My Prescriptions"
...
# === MAIN CONTENT ===
if page == "My Medications":
    render_medication_schedule_page()

elif page == "Find Pharmacy":
    render_pharmacy_finder_page()

elif page == "Drug Information":
    st.markdown("<h1 style='color: var(--primary-teal);'>🛡️ OTC Drug Database</h1>", unsafe_allow_html=True)
    ...
    if st.session_state.current_view is None:
        ...
        st.markdown("""
            <div style='text-align: center; margin: 3rem 0 2rem 0;'>
                ...
                <h1 style='color: #00897B; margin-bottom: 0.5rem;'>Welcome to MediMate</h1>
                <p style='color: #666; font-size: 16px;'>Upload a prescription to get started</p>
            </div>
        """, unsafe_allow_html=True)
        ...
        # Clinical Query
        if prompt := st.chat_input("Ask about this prescription..."):
