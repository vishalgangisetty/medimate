...
from src.ui_pages import render_reminder_page, render_pharmacy_locator_page
...
with st.sidebar:
    ...
    if st.button(lang_mgr.get_text("logout")):
        st.session_state.user = None
        st.rerun()
    ...
    page = st.radio(lang.get_text("settings"), [
        "Home", 
        lang.get_text("medicine_reminder"),
        lang.get_text("pharmacy_locator"),
        "OTC List"
    ], key="navigation")
...
if page == lang.get_text("medicine_reminder"):
    render_reminder_page()

elif page == lang.get_text("pharmacy_locator"):
